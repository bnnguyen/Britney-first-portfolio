...
import IntuitLogo from "../../../assets/experiences/IntuitLogo.jpeg"
import MailchimpLogo from "../../../assets/experiences/MailchimpLogo.jpeg"
...
export const Experiences = () => {
    return (
        ...
        <li className={styles.experienceItem}>
            ...
            <h3>Intuit Mailchimp | Atlanta, GA</h3>
            <h3>Incoming Software Developer Intern |  May 2026 - August 2026</h3>
            <p>
            ● Mailchimp Team!
            </p>
        </li>
        ...
        <li className={styles.experienceItem}>
            ...
            <p>
            ● Designed research methods and implemented deep learning algorithms with <div className={styles.specialText}>Convolutional Neural Network</div> and <div className={styles.specialText}>YOLOv8</div>, achieving a <div className={styles.specialText}>98%</div> blink rate detection accuracy by reviewing academic literature, comparing approaches, and devising test cases.<br/> <br/>
            ● Developed the main program in <div className={styles.specialText}>Python</div> using the <div className={styles.specialText}>FaceMesh</div> module from <div className={styles.specialText}>MediaPipe</div> and <div className={styles.specialText}>CVZone</div> libraries, boosting the Jetson Nano camera's FPS from <div className={styles.specialText}>5 to 20</div>, enhancing real-time detection performance by <div className={styles.specialText}>200%</div>.<br/> <br/>
            ● Co-authored a <a href="https://drive.google.com/file/d/1fIGrtXEDzqm4JUNLlybB6iBr2WXxoPOd/view" target="_blank"><strong>research paper</strong></a>; presented to Vietnam's top university professors, becoming a semi-finalist in the Vietnam Science and Engineering Fair; awarded <div className={styles.specialText}>3rd place</div> at PTNK Science Community's Research Symposium.
            </p>
        </li>
        <li className={styles.experienceItem}>
            <div className={styles.logo}>
            ...
            <p>
            ● Led a team of four in training machine learning models on anonymized US income data, focusing on income prediction.<br/> <br/>
            ● Implemented core <div className={styles.specialText}>machine learning algorithms (KNNs, Decision Trees, Logistic Regression, Neural Networks)</div> using <div className={styles.specialText}>Python (scikit-learn, numpy, pandas, imbalance-learn, matplotlib, optuna)</div> to analyze data effectively; built ensemble models with <div className={styles.specialText}>AutoML</div> and <div className={styles.specialText}>auto-sklearn</div>; optimized hyperparameters and interpreted feature importance using <div className={styles.specialText}>SHAP</div>.<br/> <br/>
            ● Measured accuracy using <div className={styles.specialText}>precision, recall, and F1 score</div>; visualized datasets and plotted graphs.<br/> <br/>
            ● Leveraged <div className={styles.specialText}>AWS services (Amazon SageMaker Notebooks, Amazon S3, and Amazon EC2)</div> to streamline model training; presented findings, experiment summaries, and data insights to company representatives; achieved a <div className={styles.specialText}>94.8% prediction accuracy</div>.
            </p>
        </li>
        <li className={styles.experienceItem}>
            <div className={styles.logo}>
            ...
            <p>
            ● Constructed and assessed cost-effective wall plotter machine alternatives using <div className={styles.specialText}>Python, Arduino (C++), and Processing (Java)</div>.<br/> <br/>
            ● Tested over 10 stepper motor models with sensors to achieve a 91.7% accuracy in line drawing on walls.<br/> <br/>
            ● Fabricated machine parts with a laser cutter and 3D printer, <div className={styles.specialText}>reducing production costs by 47.8%</div>.<br/> <br/>
            ● Co-authored research paper: “Improving the Cost and Efficiency of Wall Plotting Machine” to disseminate findings.
            </p>
        </li>
        <h4>Leadership</h4>
        <li className={styles.experienceItem}>
            ...
            ● Designed <div className={styles.specialText}>12 lectures on Google Colab</div>, teaching <div className={styles.specialText}>fundamental ML algorithms</div> and <div className={styles.specialText}>data processing techniques</div> in Python.
            </p>
        </li>
        </section>
    )
